...
def generate_plot(t1: str,
    ...
    cumulated_buy_amounts = {t1_name: cumulated_sell_amounts[t2_name] * xrates,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        't1',
        type=str,
        help="The name of the first token.")

    parser.add_argument(
        't2',
        type=str,
        help="The name of the second token.")
